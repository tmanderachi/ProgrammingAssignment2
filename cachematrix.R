...
## This function will create a list of functions that 
## attach the solve for inverse and caching ability to a matrix
...
## This function will solve or return the cached inverse of the matrix
